...
public class ScourgeAasimarUtils {
    ...
    public List<CharRaceAbility> formAbilities(Character character) {
        ...
        Optional<Ability> abilityPresent4 = Optional.ofNullable(abilityRepo.findByName("ИСПУСКАНИЕ СИЯНИЯ"));
                        ...
                        if (CharacterCalculator.getLevel(character.getExperience()) >= 3) {
                            ability = Ability.builder()
                                    ...
                                    .description("""
                                            ...
                                            себя излучать испепеляющий свет, льющийся из ваших глаз и рта и угрожающий \
                                            опалить вас. Ваше превращение длится 1 минуту или пока вы не окончите его \
                                            бонусным действием.
                                            Во время превращения вы излучаете яркий свет в пределах 10 футов и тусклый свет \
                                            в пределах ещё 10 футов, и в конце каждого вашего хода, вы и каждое существо \
                                            в пределах 10 футов от вас получаете урон излучением, равный половине вашего \
                                            уровня (округленного в большую сторону).
                                            Кроме того, раз в свой ход вы можете нанести дополнительный урон излучением \
                                            одной цели, когда вы наносите ей урон атакой или заклинанием. \
